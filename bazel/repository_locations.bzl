...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    numactl = dict(
        project_name = "numactl",
        project_desc = "NUMA support for Linux ",
        project_url = "https://github.com/numactl/numactl",
        version = "2.0.19",
    ...
    uadk = dict(
        ...
        extensions = ["envoy.tls.key_providers.kae"],
        cpe = "N/A",
        license = "Apache-2.0",
        license_url = "https://github.com/Linaro/uadk/blob/v{version}/LICENSE",
    ),
    ...
    grpc_httpjson_transcoding = dict(
        ...
        use_category = ["dataplane_ext"],
        extensions = ["envoy.filters.http.grpc_json_transcoder", "envoy.filters.http.grpc_field_extraction", "envoy.filters.http.proto_message_extraction", "envoy.filters.http.grpc_json_reverse_transcoder", "envoy.filters.http.mcp"],
    ...
    com_google_protoconverter = dict(
        ...
        use_category = ["dataplane_core", "controlplane", "dataplane_ext"],
