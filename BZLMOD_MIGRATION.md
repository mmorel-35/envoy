...
- **flatbuffers** (25.2.10) → com_github_google_flatbuffers - Cross-platform serialization library
- **highway** (1.2.0) - Portable SIMD library for performance-critical applications
- **fast_float** (8.0.2) - High-performance floating-point parsing library
- **gperftools** (2.17.2) → com_github_gperftools_gperftools - CPU profiler and heap checker
...
- **re2** (2024-07-02.bcr.1) → com_googlesource_code_re2 - Regular expression library
...
#### Recently Migrated:
1. **com_github_google_flatbuffers** → flatbuffers - Migrated to BCR version 25.2.10
2. **highway** → highway - Migrated to BCR version 1.2.0
3. **fast_float** → fast_float - Migrated to BCR version 8.0.2
4. **com_github_gperftools_gperftools** → gperftools - Migrated to BCR version 2.17.2
