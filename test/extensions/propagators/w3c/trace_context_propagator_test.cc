...
TEST_F(W3CTraceContextPropagatorTest, ExtractValid) {
  Tracing::TestTraceContextImpl trace_context{{"traceparent", "00-0af7651916cd43dd8448eb211c80319c-b7ad6b7169203331-01"}};
...
TEST_F(W3CTraceContextPropagatorTest, ExtractNotSampled) {
  Tracing::TestTraceContextImpl trace_context{{"traceparent", "00-0af7651916cd43dd8448eb211c80319c-b7ad6b7169203331-00"}};
...
TEST_F(W3CTraceContextPropagatorTest, ExtractInvalidLength) {
  Tracing::TestTraceContextImpl trace_context{{"traceparent", "00-0af7651916cd43dd8448eb211c80319c-b7ad6b7169203331"}};
...
TEST_F(W3CTraceContextPropagatorTest, ExtractInvalidFormat) {
  Tracing::TestTraceContextImpl trace_context{{"traceparent", "invalid-format-header-value-0000000000000000000000000000"}};
...
TEST_F(W3CTraceContextPropagatorTest, ExtractAllZeroTraceId) {
  Tracing::TestTraceContextImpl trace_context{{"traceparent", "00-00000000000000000000000000000000-b7ad6b7169203331-01"}};
...
TEST_F(W3CTraceContextPropagatorTest, ExtractAllZeroSpanId) {
  Tracing::TestTraceContextImpl trace_context{{"traceparent", "00-0af7651916cd43dd8448eb211c80319c-0000000000000000-01"}};
...
TEST_F(W3CTraceContextPropagatorTest, Inject) {
  Tracers::OpenTelemetry::SpanContext span_context("00", "0af7651916cd43dd8448eb211c80319c", "b7ad6b7169203331", true, "rojo=00f067aa0ba902b7");
  Tracing::TestTraceContextImpl trace_context{{}};
...
TEST_F(W3CTraceContextPropagatorTest, InjectNotSampled) {
  Tracers::OpenTelemetry::SpanContext span_context("00", "0af7651916cd43dd8448eb211c80319c", "b7ad6b7169203331", false, "");
  Tracing::TestTraceContextImpl trace_context{{}};
...
TEST_F(W3CTraceContextPropagatorTest, Name) {
  EXPECT_EQ("tracecontext", propagator_->name());
}
