...
TEST_F(CompositePropagatorTest, ExtractW3CHeaders) {
  Http::TestRequestHeaderMapImpl headers{{"traceparent", "00-00000000000000010000000000000002-0000000000000003-01"}};
  Tracing::TestTraceContextImpl trace_context{headers};
...
TEST_F(CompositePropagatorTest, B3SingleHeaderFormat) {
  Http::TestRequestHeaderMapImpl headers{{"b3", "0000000000000001-0000000000000002-1-0000000000000004"}};
  Tracing::TestTraceContextImpl trace_context{headers};
