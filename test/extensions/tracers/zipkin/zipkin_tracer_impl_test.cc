...
TEST_F(ZipkinDriverTest, NoB3ContextSampledTrue) {
  ...
  EXPECT_TRUE(!request_headers_.get(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SPAN_ID.key()).has_value());
  EXPECT_TRUE(!request_headers_.get(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_TRACE_ID.key()).has_value());
  EXPECT_TRUE(!request_headers_.get(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SAMPLED.key()).has_value());
...
TEST_F(ZipkinDriverTest, PropagateB3NoSampleDecisionSampleTrue) {
  ...
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_TRACE_ID.key(),
                       Hex::uint64ToHex(generateRandom64()));
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SPAN_ID.key(),
                       Hex::uint64ToHex(generateRandom64()));
  EXPECT_TRUE(!request_headers_.get(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SAMPLED.key()).has_value());
...
TEST_F(ZipkinDriverTest, PropagateB3NotSampled) {
  ...
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SAMPLED.key(), NOT_SAMPLED);
  Tracing::SpanPtr span = driver_->startSpan(config_, request_headers_, stream_info_,
                                             operation_name_, {Tracing::Reason::Sampling, true});

  request_headers_.remove(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SAMPLED.key());

  span->injectContext(request_headers_, Tracing::UpstreamContext());

  auto sampled_entry = request_headers_.get(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SAMPLED.key());
...
TEST_F(ZipkinDriverTest, PropagateB3NotSampledWithFalse) {
  ...
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SAMPLED.key(), sampled);
  Tracing::SpanPtr span = driver_->startSpan(config_, request_headers_, stream_info_,
                                             operation_name_, {Tracing::Reason::Sampling, true});
...
TEST_F(ZipkinDriverTest, ZipkinSpanContextFromB3HeadersTest) {
  ...
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_TRACE_ID.key(), trace_id);
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SPAN_ID.key(), span_id);
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_PARENT_SPAN_ID.key(), parent_id);
...
TEST_F(ZipkinDriverTest, ZipkinSpanContextFromB3HeadersEmptyParentSpanTest) {
  ...
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_TRACE_ID.key(), id);
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SPAN_ID.key(), id);
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SAMPLED.key(), SAMPLED);

  // Set parent span id to empty string, to ensure it is ignored
  const std::string parent_span_id = "";
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_PARENT_SPAN_ID.key(), parent_span_id);
...
TEST_F(ZipkinDriverTest, ZipkinSpanContextFromInvalidTraceIdB3HeadersTest) {
  ...
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_TRACE_ID.key(), std::string("xyz"));
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SPAN_ID.key(),
                       Hex::uint64ToHex(generateRandom64()));
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_PARENT_SPAN_ID.key(),
                       Hex::uint64ToHex(generateRandom64()));
...
TEST_F(ZipkinDriverTest, ZipkinSpanContextFromInvalidSpanIdB3HeadersTest) {
  ...
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_TRACE_ID.key(),
                       Hex::uint64ToHex(generateRandom64()));
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SPAN_ID.key(), std::string("xyz"));
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_PARENT_SPAN_ID.key(),
                       Hex::uint64ToHex(generateRandom64()));
...
TEST_F(ZipkinDriverTest, ZipkinSpanContextFromInvalidParentIdB3HeadersTest) {
  ...
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_SPAN_ID.key(),
                       Hex::uint64ToHex(generateRandom64()));
  request_headers_.set(Envoy::Extensions::Propagators::B3::Constants::get().X_B3_PARENT_SPAN_ID.key(), std::string("xyz"));
