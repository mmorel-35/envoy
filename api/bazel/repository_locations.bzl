...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_envoyproxy_protoc_gen_validate = dict(
        project_name = "protoc-gen-validate",
        project_desc = "Protocol Buffer Validation (legacy)",
        project_url = "https://github.com/bufbuild/protoc-gen-validate",
        use_category = ["api"],
        sha256 = "5b1b9ded3ef79ae8fc9edee84c36e8e8bdd1e71f2b91fa4f37c55aecbb806374",
        version = "1.0.4",
        urls = ["https://github.com/bufbuild/protoc-gen-validate/archive/refs/tags/v{version}.tar.gz"],
