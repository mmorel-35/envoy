...
public:
   ...
   */
  virtual absl::StatusOr<Tracers::OpenTelemetry::SpanContext> extract(const Tracing::TraceContext& trace_context) = 0;
   ...
   */
  virtual void inject(const Tracers::OpenTelemetry::SpanContext& span_context, Tracing::TraceContext& trace_context) = 0;
...
public:
   ...
   */
  absl::StatusOr<Tracers::OpenTelemetry::SpanContext> extract(const Tracing::TraceContext& trace_context);
   ...
   * @param trace_context The HTTP headers to inject into.
   */
  void inject(const Tracers::OpenTelemetry::SpanContext& span_context, Tracing::TraceContext& trace_context);
