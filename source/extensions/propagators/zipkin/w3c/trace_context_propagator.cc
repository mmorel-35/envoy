...
W3CTraceContextPropagator::parseTraceparent(absl::string_view traceparent) {
  ...
  return Extensions::Tracers::Zipkin::SpanContext(trace_id_high, trace_id_low, span_id, parent_id, sampled);
}

std::string W3CTraceContextPropagator::formatTraceparent(const Extensions::Tracers::Zipkin::SpanContext& span_context) {
