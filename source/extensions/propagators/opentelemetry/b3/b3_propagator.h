...
/**
 * OpenTelemetry-specific B3 propagator supporting both single header (b3) and multi-header (X-B3-*) formats.
 * Auto-detects format on extraction, injects both formats for maximum compatibility.
 * 
 * This propagator is optimized for OpenTelemetry tracer integration and uses OpenTelemetry SpanContext types.
 * 
