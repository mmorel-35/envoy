...
GenericB3Propagator::GenericB3Propagator()
    : b3_header_("b3"),
...
absl::StatusOr<SpanContext> GenericB3Propagator::extract(const Tracing::TraceContext& trace_context) {
...
void GenericB3Propagator::inject(const SpanContext& span_context, Tracing::TraceContext& trace_context) {
...
std::vector<std::string> GenericB3Propagator::fields() const {
  return {
    "b3",
    "x-b3-traceid",
    "x-b3-spanid", 
...
std::string GenericB3Propagator::name() const {
  return "b3";
}

absl::StatusOr<SpanContext> GenericB3Propagator::extractSingleHeader(const Tracing::TraceContext& trace_context) {
...
absl::StatusOr<SpanContext> GenericB3Propagator::extractMultiHeader(const Tracing::TraceContext& trace_context) {
...
void GenericB3Propagator::injectSingleHeader(const SpanContext& span_context, Tracing::TraceContext& trace_context) {
...
void GenericB3Propagator::injectMultiHeader(const SpanContext& span_context, Tracing::TraceContext& trace_context) {
