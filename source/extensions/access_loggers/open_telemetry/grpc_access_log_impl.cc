...
using ExportLogsServiceRequest = ::Envoy::Common::OpenTelemetry::LogsExportRequest;
using ExportLogsServiceResponse = ::Envoy::Common::OpenTelemetry::LogsExportResponse;
    ...
    : GrpcAccessLogger(
          ...
          std::make_unique<Common::UnaryGrpcAccessLogClient<ExportLogsServiceRequest,
              ...
              *Protobuf::DescriptorPool::generated_pool()->FindMethodByName(
                  std::string(Envoy::Common::OpenTelemetry::ProtocolConstants::LOGS_SERVICE_EXPORT_METHOD)),
