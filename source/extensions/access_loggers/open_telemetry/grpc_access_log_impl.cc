...
using ExportLogsServiceRequest = ::Envoy::Common::OpenTelemetry::Logs::LogsExportRequest;
using ExportLogsServiceResponse = ::Envoy::Common::OpenTelemetry::Logs::LogsExportResponse;
    ...
    : GrpcAccessLogger(
          ...
          std::make_unique<Common::UnaryGrpcAccessLogClient<ExportLogsServiceRequest,
              ...
              *Protobuf::DescriptorPool::generated_pool()->FindMethodByName(std::string(
                  Envoy::Common::OpenTelemetry::Logs::Constants::LOGS_SERVICE_EXPORT_METHOD)),
