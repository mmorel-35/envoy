...
class GrpcAccessLoggerImpl
    : public Common::GrpcAccessLogger<
          ...
          Protobuf::Empty, ::Envoy::Common::OpenTelemetry::Logs::LogsExportRequest,
          ::Envoy::Common::OpenTelemetry::Logs::LogsExportResponse> {
public:
...
private:
  class OTelLogRequestCallbacks
      : public Grpc::AsyncRequestCallbacks<::Envoy::Common::OpenTelemetry::Logs::LogsExportResponse> {
  public:
