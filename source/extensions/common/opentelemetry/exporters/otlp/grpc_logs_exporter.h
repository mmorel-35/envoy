...
// (repeated) LogRecord.
class OtlpGrpcLogsExporter
    : public AccessLoggers::Common::GrpcAccessLogger<
...
private:
  class OTelLogRequestCallbacks
      : public Grpc::AsyncRequestCallbacks<
            opentelemetry::proto::collector::logs::v1::ExportLogsServiceResponse> {
  public:
    OTelLogRequestCallbacks(AccessLoggers::Common::GrpcAccessLoggerStats& stats,
                             uint32_t sending_log_entries,
    ...
    AccessLoggers::Common::GrpcAccessLoggerStats& stats_;
  ...
  // `OtlpGrpcLogsExporter` get deleted, it will cancel all the requests on the flight. Therefore,
  // we guarantee the OtlpGrpcLogsExporter is always alive when `OTelLogRequestCallbacks`'s
...
class OtlpGrpcLogsExporterCache
    : public AccessLoggers::Common::GrpcAccessLoggerCache<
          OtlpGrpcLogsExporter,
          envoy::extensions::access_loggers::open_telemetry::v3::OpenTelemetryAccessLogConfig> {
public:
  OtlpGrpcLogsExporterCache(Grpc::AsyncClientManager& async_client_manager, Stats::Scope& scope,
                              ThreadLocal::SlotAllocator& tls,
                              const LocalInfo::LocalInfo& local_info);

private:
  // Common::GrpcAccessLoggerCache
  OtlpGrpcLogsExporter::SharedPtr createLogger(
      const envoy::extensions::access_loggers::open_telemetry::v3::OpenTelemetryAccessLogConfig&
          config,
