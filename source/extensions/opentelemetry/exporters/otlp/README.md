...
The OTLP exporters depend on:
- OpenTelemetry protocol buffers (`@opentelemetry_proto`)
- Envoy's common OpenTelemetry types (`//source/common/opentelemetry`)
- Standard Envoy networking libraries for gRPC and HTTP