...
using ExportTraceServiceRequest = ::Envoy::Common::OpenTelemetry::Traces::TraceExportRequest;
using ExportTraceServiceResponse = ::Envoy::Common::OpenTelemetry::Traces::TraceExportResponse;
