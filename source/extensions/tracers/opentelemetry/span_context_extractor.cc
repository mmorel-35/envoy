...
SpanContext convertFromW3C(const Extensions::Propagators::W3C::TraceContext& w3c_context) {
...
bool SpanContextExtractor::propagationHeaderPresent() {
  return Extensions::Propagators::W3C::Propagator::isPresent(trace_context_);
}
