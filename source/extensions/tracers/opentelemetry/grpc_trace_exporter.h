...
// This file has moved to source/extensions/common/opentelemetry/exporters/otlp/grpc_trace_exporter.h
...
using OpenTelemetryGrpcTraceExporter =
    ::Envoy::Extensions::OpenTelemetry::OtlpGrpcTraceExporter;
