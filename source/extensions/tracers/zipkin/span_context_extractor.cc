...
SpanContextExtractor::SpanContextExtractor(Tracing::TraceContext& trace_context,
  ...
  composite_propagator_ = Extensions::Propagators::Zipkin::PropagatorFactory::createPropagators(propagator_names);
}
...
SpanContextExtractor::SpanContextExtractor(Tracing::TraceContext& trace_context,
  ...
  std::vector<std::string> names = propagator_names.empty() ? std::vector<std::string>{"b3"} : propagator_names;
  composite_propagator_ = Extensions::Propagators::Zipkin::PropagatorFactory::createPropagators(names);
}
