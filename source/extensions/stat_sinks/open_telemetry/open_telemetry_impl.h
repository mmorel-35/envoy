...
using AggregationTemporality =
    ::Envoy::Extensions::OpenTelemetry::Sdk::Metrics::AggregationTemporality;
...
using MetricsExportRequestSharedPtr =
    ::Envoy::Extensions::OpenTelemetry::Sdk::Metrics::ExportRequestSharedPtr;
